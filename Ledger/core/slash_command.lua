...
Ledger.SLASH_COMMANDS = {
    ...
    { name = "time", desc = "shows or hides the level's time-split bar (active/downtime/travel/dead), independent of /ldg bar" },
    { name = "recalc", desc = "recomputes every closed level's time buckets from its raw per-second samples, using the current thresholds" },
